...
class HotelManager:
    ...
    def __init__(self):
        #Esto es utilizado en la función checkout para forzar errores en los archivos
        #Si se quiere utilizar los archivos json correctos, se debe introducir en estos atributos
        #las rutas indicadas
